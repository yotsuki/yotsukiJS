...
var options = { 
            consumerKey: '60SNb0S9cim6Sdal8huAw', // REPLACE WITH YOUR CONSUMER_KEY
            consumerSecret: 'tjcXj1h3BZrLUZX2JxTuAT5rJanCOwhNBYHRINd5nA', // REPLACE WITH YOUR CONSUMER_SECRET
            //            callbackUrl: "http://www.cyberfront.co.jp" }; // YOUR URL 
            callbackUrl: "http://game.cyberfrontonline.com/info/r11twitter.html"}; // YOUR URL 
...
function Twitter() {
    ...
    this.init	= function(){
		...
		if(rawData !== null && rawData != ""){
		    ...
		    console.log("ppppppppppppppppppppppppppppp0");
		    ...
		    console.log("ppppppppppppppppppppppppppppp1");
		    ...
		    console.log("ppppppppppppppppppppppppppppp2");
				    ...
				    window.plugins.childBrowser.onLocationChange = function(loc){_twitter.success(loc); };// ‚È‚ñ‚©”÷–­
				},
				function(data) { 
	...
	*/
    this.success	= function(loc){
		...
		*/
//		if (loc.indexOf("http://www.cyberfront.co.jp/?") >= 0) {
		if (loc.indexOf("http://game.cyberfrontonline.com/info/") >= 0) {
...
//						$('#stage-data').show();
					    ...
					    keyFlag	= JSON.stringify(accessData);
...
//									app.init();
				...
				function(data) { 
				    localStorage.setItem(twitterKey,"");
				    window.plugins.childBrowser.close();
//				    console.log("ppppppppppppppppppppppppppppp222");
				    console.log(data);
				}
			);
		}
	...
	*/
    this.post	= function(_str){
//		var theTweet = $("#tweet").val(); // Change this out for what ever you want!
		var theTweet = _str; // Change this out for what ever you want!
